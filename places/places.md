...
[Глвня](https://github.com/tolyaganzin/skyscanner-RU) [<-База](https://github.com/tolyaganzin/skyscanner-RU/blob/master/base/base.md) | [Отели->](https://github.com/tolyaganzin/skyscanner-RU/blob/master/hotels/hotels.md)
...
* Получение списка всех мест (подробность ограничена до города), которые поддерживает апиха [перейти](#cписка-всех-мест-запрос-типа-get)
* Получает список мест по строке запроса [перейти](#cписок-мест-по-строке-запроса-запрос-типа-get)
* Получает информацию про: страну, город или аеропорт - используя их ID [перейти](#Информацию-про-страну-город-или-аеропорт-запрос-типа-get)
* Аренда авто и номеров отелей [перейти](#Аренда-авто-и-номеров-отелей-запрос-типа-get)
