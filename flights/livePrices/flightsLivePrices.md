...
* Создание сессии [перейти](#Создание-сессии-запрос-типа-post)
* Получение данных сессии [перейти](#Получение-данных-сессии-запрос-типа-get)
* Получение данных деталей сессии [перейти](#Получение-данных-деталей-сессии-запрос-типа-get)
